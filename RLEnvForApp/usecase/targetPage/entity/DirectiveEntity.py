...
class DirectiveEntity:
    def __init__(self, url: str, dom: str, formXPath: str, appEventEntities: [AppEventEntity], codeCoverageEntities: [CodeCoverageEntity], formInputValueEntities: [FormInputValueEntity]):
        self._url = url
        self._dom = dom
        self._formXPath = formXPath
        self._appEventEntities = appEventEntities
        self._codeCoverageEntities = codeCoverageEntities
        self._formInputValueEntities = formInputValueEntities
    ...
    def getFormInputValueEntities(self) -> [FormInputValueEntity]:
        return self._formInputValueEntities
