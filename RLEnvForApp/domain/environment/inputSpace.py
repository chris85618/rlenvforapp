...
inputValues = [[""],
               ["superuser@example.com", "vector@selab.com", "vector@selab.com", "admin@example.com"],
               ["superuser", "vector@selab.com", "Pete Kessler", "Gladyce"],
               ["testing", "selab1623", "password", "password"],
