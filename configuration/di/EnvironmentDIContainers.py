...
from RLEnvForApp.adapter.environment.actionCommandFactoryService.defaultValue.DefaultValueJsonFetcher import *
...
class EnvironmentDIContainers(containers.DeclarativeContainer):
    ...
    defaultValueFetcher = providers.Factory(
        DIConfiguration.get_class_name(config.Environment.default_value_fetcher())
    )
